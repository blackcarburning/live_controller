...
class LiveControllerMac(QWidget):
    ...
    def pick_count_in_color(self):
        ...
        if color.isValid():
            ...
            self.count_in_color_button.setStyleSheet(f"background-color: {self.count_in_bg_color}; min-height: 18px; max-height: 18px;")
            self.apply_overlay_styles()
    ...
    def pick_track_play_color(self):
        ...
        if color.isValid():
            ...
            self.track_play_color_button.setStyleSheet(f"background-color: {self.track_play_bg_color}; min-height: 18px; max-height: 18px;")
            self.apply_overlay_styles()
    ...
    def apply_color_scheme(self, scheme):
        ...
        for key, btn in self._scheme_swatches.items():
            ...
            btn.setStyleSheet(
                f"background-color: {color}; border-radius: 4px; border: 1px solid #38383a; min-height: 18px; max-height: 18px;"
            )
